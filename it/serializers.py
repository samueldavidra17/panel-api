...
class usuariosSerializers(serializers.ModelSerializer):
    class Meta: 
        model = usuarios
        fields = ('id','cargo','nombre','departamentosforeignkey')
    
    def to_representation(self, value):
        return {"id": value.id, "cargo": value.cargo, "nombre": value.nombre, "departamento": {"nombre": value.departamentosforeignkey.nombre, "empresa": {"id": value.departamentosforeignkey.empresasforeignkey.id, "nombre": value.departamentosforeignkey.empresasforeignkey.nombre}}}
